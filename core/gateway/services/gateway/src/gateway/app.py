...
def create_app(
    ...
    *,
    ...
    @app.get("/meetings/{meeting_id}/attributed-audio")
    async def get_attributed_audio_manifest(meeting_id: int, request: Request):
        return await _forward("GET", _meeting(f"/meetings/{meeting_id}/attributed-audio"), request)
